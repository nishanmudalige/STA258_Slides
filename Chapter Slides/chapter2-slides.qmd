...
**Variables** store one value; **vectors** store many of one type.<br>**Lists**, **matrices**, **arrays**, **factors**, and **data frames** organize richer data.<br>**Indexing** with `[ ]` selects elements, rows, and columns.
:::
::: {.card .fragment}
