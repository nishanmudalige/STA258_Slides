...
ggplot(ci_df, aes(y = sim)) +
  geom_segment(aes(x = lower, xend = upper, colour = misses), linewidth = 1.1) +
  geom_vline(xintercept = true_mu, linetype = "dashed", colour = "#004d40") +
  scale_colour_manual(values = c("FALSE" = "#00695c", "TRUE" = "#f9a825"), guide = "none") +
  labs(x = "Interval endpoints", y = "Simulation") +
