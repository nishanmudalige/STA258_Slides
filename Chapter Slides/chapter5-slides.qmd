...
**By hand:** Use the conservative value
$df=\min(n_1-1,\;n_2-1)$. The longer Welch degrees-of-freedom calculation
is not required in this course.

**In R:** `t.test(..., var.equal = FALSE)` uses the more accurate
Welch–Satterthwaite approximation, so the degrees of freedom and interval
endpoints may differ slightly. **This is expected.**
:::
