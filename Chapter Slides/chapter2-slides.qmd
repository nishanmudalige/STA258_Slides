...
.rstudio-diagram {
  display: grid;
  grid-template-columns: 230px 730px 230px;
  align-items: center;
...
::: {.fragment}
<img src="images/RStudio_overview.png" alt="Annotated RStudio overview" style="display: block; margin: 14px auto 0 auto; max-width: 88%; max-height: 400px; border: 1px solid var(--sta-border); border-radius: 8px; box-shadow: 0 4px 14px rgba(0,0,0,0.18);">
:::
