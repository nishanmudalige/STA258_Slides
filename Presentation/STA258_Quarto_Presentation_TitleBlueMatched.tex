...
\setbeamertemplate{frametitle}{%
  ...
  \begin{beamercolorbox}[wd=\paperwidth,ht=0.86cm,dp=0.18cm,leftskip=0.36cm]{frametitle}%
    \raisebox{-0.05cm}{\includegraphics[height=0.42cm]{UTM-MCS-logo-white-clean.png}}%
    \hspace{0.55cm}%
...
\vspace{0.6em}
{\Large\bfseries Scan to explore the current course\par resource:}
...
{\ttfamily\small
\begin{tabular}{@{}l@{}}
https://nishanmudalige.github.io/STA258\_\\
Slides/
\end{tabular}}
...
\begin{center} \fcolorbox{Pantone633!35}{white}{\includegraphics[width=0.93\textwidth,height=4.55cm,keepaspectratio]{cropped_example_concept_visualization.png}} \end{center}
\vspace{-0.25em}
\begin{itemize}
...
\begin{center} \fcolorbox{Pantone633!35}{white}{\includegraphics[width=0.93\textwidth,height=4.20cm,keepaspectratio]{cropped_example_check_in_r.png}} \end{center}
\vspace{-0.25em}
\begin{itemize}
...
\begin{center} \fcolorbox{Pantone633!35}{white}{\includegraphics[width=0.93\textwidth,height=4.55cm,keepaspectratio]{cropped_example_formative_feedback.png}} \end{center}
\vspace{-0.25em}
\begin{itemize}
...
\begin{center} \fcolorbox{Pantone633!35}{white}{\includegraphics[width=0.93\textwidth,height=4.55cm,keepaspectratio]{cropped_example_interactive_visualization.png}} \end{center}
\vspace{-0.25em}
\begin{itemize}
