...
::: {.taskbox style="grid-column: 1; grid-row: 1; font-size: 0.63em; line-height: 1.16; padding: 11px 15px; margin-bottom: 0;"}
A website team is planning a large online registration page.

Before launch, they want to estimate the **mean time** it takes a user to complete the entry form.

From previous launches, the population standard deviation is treated as known:
...
Find the sample size needed for a confidence interval for the population mean entry-form completion time.

The margin of error should be no more than **5 seconds**.
:::

::: {.examplebox style="grid-column: 2; grid-row: 2; font-size: 0.66em; line-height: 1.16; padding: 12px 15px; margin-bottom: 0; display: flex; align-items: center;"}
The team should sample at least **89 users** to estimate the mean entry-form completion time within **5 seconds** at 95% confidence.
:::
