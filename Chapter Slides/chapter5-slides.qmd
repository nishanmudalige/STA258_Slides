...
## Example: GTA VI Trailer Alert Comparison

:::: {.example-grid style="display: grid; grid-template-columns: 0.87fr 1.13fr; grid-template-rows: auto auto; gap: 10px 18px; align-items: stretch;"}

::: {.taskbox style="grid-column: 1; grid-row: 1; font-size: 0.63em; line-height: 1.16; padding: 11px 15px; margin-bottom: 0;"}
A gaming news app wants to compare two ways of promoting a GTA VI trailer
drop.

One group receives a direct push notification about the trailer. The
other group only sees a generic homepage banner.

<br>

**Group 1: Push notification users**  
$x_1=210$ of $n_1=500$ watched the trailer within 24 hours

**Group 2: Homepage banner users**  
$x_2=170$ of $n_2=450$ watched the trailer within 24 hours
:::
...
values mean the push notification has the higher population proportion of
users who watch the trailer.
:::
...
We are 90% confident that the push notification's population proportion
is between **1.00 percentage point lower and 9.45 percentage points
higher** than the homepage banner's population proportion.
:::
...
<ul class="assumption-list" style="gap: 10px;">
  ...
  <li><strong>Sample size requirement:</strong> Both selected sample sizes should be greater than 70.</li>
</ul>
:::
...
## Example: Offline Downloads

:::: {.example-grid style="display: grid; grid-template-columns: 0.87fr 1.13fr; grid-template-rows: auto auto; gap: 10px 18px; align-items: stretch;"}

::: {.taskbox style="grid-column: 1; grid-row: 1; font-size: 0.63em; line-height: 1.16; padding: 11px 15px; margin-bottom: 0;"}
A streaming app wants to compare two reminder designs for users who may
want to download shows before travelling or going somewhere with poor
Wi-Fi.

One group receives a personalized offline-download reminder. The other
group sees a generic homepage prompt.

<br>

**Group 1: Personalized reminder users**  
$x_1=210$ of $n_1=500$ downloaded at least one show offline

**Group 2: Generic prompt users**  
$x_2=170$ of $n_2=450$ downloaded at least one show offline
:::
...
The order is **personalized reminder minus generic prompt**, so positive
values mean the personalized reminder has the higher population
proportion of users who download shows offline.
:::

::: {.examplebox style="grid-column: 2; grid-row: 2; font-size: 0.66em; line-height: 1.16; padding: 12px 15px; margin-bottom: 0; display: flex; align-items: center;"}
We are 90% confident that the personalized reminder's population
proportion is between **1.00 percentage point lower and 9.45 percentage
points higher** than the generic prompt's population proportion.
:::
...
::: {.taskbox style="grid-column: 1; grid-row: 1; font-size: 0.63em; line-height: 1.16; padding: 11px 15px; margin-bottom: 0;"}
A researcher wants to study whether regular Vitamin C use is associated
with fewer sick days during cold season.

The same 12 people are observed across two comparable winter periods:
one without regular Vitamin C use and one with regular Vitamin C use.
...
between **0.98 and 2.52 fewer sick days**, on average, for people like
those in this paired study.
:::
...
## Example: MrBeast 500M Giveaway Survey

:::: {.example-grid style="display: grid; grid-template-columns: 0.87fr 1.13fr; grid-template-rows: auto auto; gap: 10px 18px; align-items: stretch;"}

::: {.taskbox style="grid-column: 1; grid-row: 1; font-size: 0.63em; line-height: 1.16; padding: 11px 15px; margin-bottom: 0;"}
After MrBeast reaches 500 million YouTube subscribers, his team plans a
large online giveaway to celebrate the milestone.

Before launch, they want to estimate the proportion of subscribers who
would actually enter the giveaway.

A previous fan survey suggests a planning value of:

$$
p^*=0.156
$$

The team wants the margin of error to be at most:
...
proportion of subscribers who would enter the 500M giveaway.

The margin of error should be no more than **3 percentage points**.
:::

::: {.examplebox style="grid-column: 2; grid-row: 2; font-size: 0.66em; line-height: 1.16; padding: 12px 15px; margin-bottom: 0; display: flex; align-items: center;"}
The team should survey at least **563 subscribers** for 95% confidence
and **971 subscribers** for 99% confidence. Higher confidence requires a
larger sample size when the margin of error stays fixed.
:::
...
Find the required sample size for 90%, 95%, and 99% confidence.
:::
...
| Confidence | $z^*$ | Calculation | Required $n$ |
|:--:|:--:|:--:|:--:|
| 90% | 1.645 | $\left(\frac{1.645(22.5)}{2}\right)^2=342.41$ | 343 |
| 95% | 1.960 | $\left(\frac{1.960(22.5)}{2}\right)^2=486.20$ | 487 |
| 99% | 2.576 | $\left(\frac{2.576(22.5)}{2}\right)^2=839.45$ | 840 |
:::
...
The only thing changing across rows is the confidence level.
:::

::: {.examplebox style="grid-column: 2; grid-row: 2; font-size: 0.66em; line-height: 1.16; padding: 12px 15px; margin-bottom: 0; display: flex; align-items: center;"}
Higher confidence requires a larger sample size. To keep the same
2-second margin of error, the app needs **343 trips** for 90% confidence,
**487 trips** for 95%, and **840 trips** for 99%.
:::
...
## Example: App Load-Time Estimate

:::: {.example-grid style="display: grid; grid-template-columns: 0.87fr 1.13fr; grid-template-rows: auto auto; gap: 10px 18px; align-items: stretch;"}

::: {.taskbox style="grid-column: 1; grid-row: 1; font-size: 0.63em; line-height: 1.16; padding: 11px 15px; margin-bottom: 0;"}
A mobile app team wants to estimate the average loading time for a new
feature.

A small pilot study gives an estimated standard deviation of:

$$
s=12\text{ seconds}
$$

The team wants a 95% confidence interval with margin of error at most:
...
Because $\sigma$ is unknown, the pilot estimate $s=12$ is used.
:::

::: {.examplebox style="grid-column: 2; grid-row: 2; font-size: 0.66em; line-height: 1.16; padding: 12px 15px; margin-bottom: 0; display: flex; align-items: center;"}
The iteration stabilizes at **25**, so the app team should test at least
**25 loading times** to keep the margin of error at most 5 seconds.
:::
...
The app wants a 90% confidence interval with margin of error at most:
...
Find the sample size needed for a 90% confidence interval for the
population mean extra grocery-delivery cost.

Because $\sigma$ is unknown, the pilot estimate $s=18$ is used.
:::

::: {.examplebox style="grid-column: 2; grid-row: 2; font-size: 0.66em; line-height: 1.16; padding: 12px 15px; margin-bottom: 0; display: flex; align-items: center;"}
The iteration stabilizes at **57**, so the app should sample at least
**57 grocery-delivery orders** to keep the margin of error at most
4 dollars.
:::
...
## Example: Sabrina Carpenter Merch Survey

:::: {.example-grid style="display: grid; grid-template-columns: 0.87fr 1.13fr; grid-template-rows: auto auto; gap: 10px 18px; align-items: stretch;"}

::: {.taskbox style="grid-column: 1; grid-row: 1; font-size: 0.63em; line-height: 1.16; padding: 11px 15px; margin-bottom: 0;"}
A merch company is planning a limited online drop connected to a Sabrina
Carpenter concert weekend.

Before the drop, the company wants to estimate the proportion of people
on the waitlist who plan to buy merch when it goes live.
...
Find the sample size needed for a confidence interval for the population
proportion of waitlist users who plan to buy Sabrina Carpenter merch.
