...
## Example: USA-Canada Hockey Shot-Speed Comparison
...
## Check in R: Known Sigma Difference of Means

:::: {.two-col-wide}
::: {.col}
::: {.notebox style="font-size: 0.68em; line-height: 1.22; padding: 13px 16px; margin-top: 10px;"}
<span class="label">What this checks</span>

This checks the **USA-Canada hockey shot-speed** example.

We are constructing a 95% confidence interval for:
...
Since both population standard deviations are known, we use a **two-sample z interval**.
:::

::: {.thinkbox style="font-size: 0.64em; line-height: 1.18; padding: 12px 15px; margin-top: 12px;"}
<span class="label">Reminder</span>

This is the rare known-sigma case, so there is only one worked example for this topic.
:::
:::
...
# Known sigma difference of means
# Example: USA-Canada hockey shot speeds
...
estimate of $p$ is available. What value should we use for $p_0$?
:::
